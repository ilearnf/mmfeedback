	...
	public class HomeControllerTest
	{
		...
		public void TestPagingNext ()
		{
			...
			mock.Setup (x => x.Reviews).Returns (new List<Review> () {
				...
				new Review () { Title = "title11", Description = "programming o", Id = 1,
					CommunityUrl = "url", CommunutyDiscussionsCount = 0, Author = null,
					Category = "", Tags = new string[]{ "programming", "okulovskiy" }, Date = "1.1.1"
				},
				new Review () { Title = "title12", Description = "programming o", Id = 1,
					CommunityUrl = "url", CommunutyDiscussionsCount = 0, Author = null,
					Category = "", Tags = new string[]{ "programming", "okulovskiy" }, Date = "1.1.1"
				}, 
				new Review () { Title = "title13", Description = "programming e", Id = 1,
					CommunityUrl = "url", CommunutyDiscussionsCount = 0, Author = null,
					Category = "", Tags = new string[]{ "programming", "egorov" }, Date = "1.1.1"
				},
				new Review () { Title = "title14", Description = "misc e", Id = 1,
					CommunityUrl = "url", CommunutyDiscussionsCount = 0, Author = null,
			...
			contextMock.Setup (x => x.HttpContext.Request["X-Requested-With"]).Returns ("XMLHttpRequest");
			...
			Assert.AreEqual (reviewsArray[0].Title, "title11");
			Assert.AreEqual (reviewsArray[3].Title, "title14");
		}
